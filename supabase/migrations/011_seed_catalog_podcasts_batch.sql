-- Re-add / ensure flagship catalog podcasts (idempotent on slug).
-- Eight rows mirror 004 + 005 naming; two are new (treasuries, mining pod).
...
(
  ...
  'Insider-level analysis of corporate Bitcoin adoption from BitcoinTreasuries.net—interviews, SEC-driven company breakdowns, and treasury roundtables.',
  'https://feed.podbean.com/bitcointreasuries/feed.xml',
  'https://bitcointreasuries.podbean.com',
  false, true, true, 2024,
  'weekly', 'intermediate',
...
(
  'the-mining-pod',
  'The Mining Pod',
  'Bitcoin mining news and operator-level strategy.',
  'Twice-weekly coverage of Bitcoin mining markets, operators, and policy—from Blockspace Media.',
  'https://feeds.megaphone.fm/theminingpod',
  'https://blockspace.media/',
  false, true, true, 2021,
  'weekly', 'intermediate',
  array['mining','energy','markets'],
  null
)
on conflict (slug) do nothing;

-- Cover art (matches 004 for the eight originals; new shows from feed artwork).
...
update public.podcasts
set cover_image_url = 'https://pbcdn1.podbean.com/imglogo/image-logo/21973974/bt-pod-art.png'
where slug = 'the-bitcoin-treasuries-podcast';

update public.podcasts
set cover_image_url = 'https://megaphone.imgix.net/podcasts/251f7e78-db3f-11ee-96ec-ff0c9910c063/image/bc15fb440ea81c05d247e43fffc0caea.png?ixlib=rails-4.3.1&max-w=3000&max-h=3000&fit=crop&auto=format,compress'
where slug = 'the-mining-pod';
